package com.aiquest.juego;

import java.util.ArrayList;
import java.util.List;

import com.aiquest.juego.ciudades.ordenamientos.Caja;
import com.aiquest.juego.ciudades.ordenamientos.OrdenadorBubble;
import com.aiquest.juego.ciudades.ordenamientos.OrdenadorSelection;
import com.aiquest.juego.ciudades.ordenamientos.PartidaOrdenamientos;
import com.aiquest.modelos.Jugador;
import com.aiquest.modelos.Partida;

/**
 * clase incompleta:
 * va a representar la partida principal del com.aiquest.com.aiquest.juego aiquest, maneja el todas las ciudad (las demas partidas)
 */
public class PartidaAiQuest extends Partida {
    ...
    @Override
    public void iniciar() {
        // Inicia el com.aiquest.com.aiquest.juego global
    }

    @Override
    public void finalizar() {
        // Finaliza el com.aiquest.com.aiquest.juego completo
    }
}