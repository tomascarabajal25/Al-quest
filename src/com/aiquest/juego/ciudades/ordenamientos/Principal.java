...
import com.aiquest.juego.ciudades.ordenamientos.ui.RenderOrdenamiento;
...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("(Presioná el botón 'Iniciar Animación' en la ventana para ver el com.aiquest.com.aiquest.juego correr antes de arriesgar!)");
