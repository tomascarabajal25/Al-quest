...
public class TestCiudadRecoleccion {
    ...
    public void crearCiudadConFilasCeroLanzaExcepcion() {
        Jugador jugador = new Jugador("Tomas");
        assertThrows(RuntimeException.class, () -> new CiudadRecoleccion(0, 40, 3, 10, jugador));
    }

    @Test
    public void crearCiudadConColumnasCeroLanzaExcepcion() {
        Jugador jugador = new Jugador("Tomas");
        assertThrows(RuntimeException.class, () -> new CiudadRecoleccion(40, 0, 3, 10, jugador));
    }

    @Test
    public void crearCiudadConNivelesCeroLanzaExcepcion() {
        Jugador jugador = new Jugador("Tomas");
        assertThrows(RuntimeException.class, () -> new CiudadRecoleccion(40, 40, 0, 10, jugador));
    }

    @Test
    public void crearCiudadConCapacidadMochilaCeroLanzaExcepcion() {
        Jugador jugador = new Jugador("Tomas");
        assertThrows(RuntimeException.class, () -> new CiudadRecoleccion(40, 40, 3, 0, jugador));
    }

    @Test
    public void crearCiudadConJugadorNuloLanzaExcepcion() {
        assertThrows(RuntimeException.class, () -> new CiudadRecoleccion(40, 40, 3, 10, null));
    }
    ...
    public void finalizarDevuelveLosPuntosActuales() {
        Jugador jugador = new Jugador("Tomas");
        CiudadRecoleccion ciudad = new CiudadRecoleccion(40, 40, 3, 10, jugador);
        assertEquals(ciudad.getPuntos(), ciudad.finalizar());
    }
    ...
    public void dosCiudadesIgualesTienenMismoHashCode() {
        Jugador jugador = new Jugador("Tomas");
        CiudadRecoleccion ciudad1 = new CiudadRecoleccion(40, 40, 3, 10, jugador);
        CiudadRecoleccion ciudad2 = new CiudadRecoleccion(40, 40, 3, 10, jugador);
